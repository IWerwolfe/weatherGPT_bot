...
public class ForecastWeekCommand implements IBotCommand {
    ...
    public String getDescription() {
        return "Прогноз погоды на 7 дней";
    }

    @Override
    public void processMessage(AbsSender absSender, Message message, String[] arguments) {

        String desc = weatherService.getDescForecast(botUserServices.getUser(message.getFrom()), 7);
